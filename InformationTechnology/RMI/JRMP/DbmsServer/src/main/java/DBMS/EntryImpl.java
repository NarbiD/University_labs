...
public class EntryImpl extends UnicastRemoteObject implements Entry {
    ...
    public EntryImpl(List<Object> values, List<DataType> types, IntegerInvlConstraint constraint) throws Exception {
    ...
    public EntryImpl(JSONObject json, List<DataType> types, IntegerInvlConstraint constraint) throws Exception {
