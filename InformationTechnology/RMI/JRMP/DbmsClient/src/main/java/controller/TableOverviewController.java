...
public class TableOverviewController extends Controller {
    ...
    private void select() throws RemoteException {
            ...
            row.setOnMouseClicked(event -> {
                if (event.getClickCount() == 2 && (! row.isEmpty()) ) {
                    ...
                    if (selectedEntryIndex >= 0) {
                        ...
                        try {
                            selectedEntry = table.getEntries().get(selectedEntryIndex);
    ...
    public void editRow(Event event) throws RemoteException {
        tableSelectedIndex.set(tableOverview.getSelectionModel().getSelectedIndex());
    ...
    public void search_onClick(MouseEvent mouseEvent) throws RemoteException {
        tableSelectedIndex.set(tableOverview.getSelectionModel().getSelectedIndex());
        if (tableSelectedIndex.get() >= 0) {
            Stage stage = new Stage();
