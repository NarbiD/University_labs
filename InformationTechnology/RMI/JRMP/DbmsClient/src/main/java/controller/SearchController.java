...
public class SearchController extends Controller {
    ...
    public void submit(MouseEvent mouseEvent) {
        ...
        try {
            ...
            entriesForShow.forEach(entry -> {
                try {
                    valuesForShow.add(FXCollections.observableArrayList(entry.getValues()));
    ...
    private void showResult(ObservableList<Object> result) throws RemoteException {
