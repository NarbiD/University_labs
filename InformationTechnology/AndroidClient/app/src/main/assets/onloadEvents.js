(function() {
    ...
    $(document).ready(function () {
        ...
        $.ajax({
            type: "GET",
            url: "https://web-dbms.herokuapp.com/types/",
        ...
        $(".cancelButton").on("click", function () {
            forms.hide(this.parentNode.parentNode.parentNode);
        });
    ...
    var actions = {
        create: {
            database: function (dbName) {
                $.ajax({
                    type: "POST",
                    url: "https://web-dbms.herokuapp.com/databases/",
            ...
            table: function (dbName, dataTypes) {
                $.ajax({
                    type: "POST",
                    url: "https://web-dbms.herokuapp.com/databases/" + dbName + "/tables/",
                    contentType: "application/json; charset=utf-8",
            ...
            row: function (image) {
                ...
                $.ajax({
                    type: "POST",
                    url: "https://web-dbms.herokuapp.com/databases/" + dbName + "/tables/" + tableName + "/rows/",
                    contentType: "application/json; charset=utf-8",
        ...
        delete: {
            database: function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "https://web-dbms.herokuapp.com/databases/" + dbName,
                    success: function () {
                        forms.cleanList(".databaseList");
                        forms.cleanList(".tableList");
                        forms.cleanList(".entriesList");
            ...
            table: function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "https://web-dbms.herokuapp.com/databases/" + dbName + "/tables/" + tableName,
                    success: function () {
                        forms.cleanList(".tableList");
                        forms.cleanList(".entriesList");
